...
void CCheckFile::GetDrivers() //获取盘符
{
...
void CCheckFile::OnBnClickedUpload() //文件上传功能
{
	//获取文件要上传到的路径
	CString strTarPath;
...
void CCheckFile::GetFilePath(CString& filePath) //得到文件路径
{
...
void CCheckFile::DownLoad(LPBYTE pBuff, DWORD dwBuffSize) //下载文件
{
	//写入新文件
